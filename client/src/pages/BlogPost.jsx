...
const BlogPost = () => {
    ...
    useEffect(() => {
        const fetchBlog = async () => {
            try {
                ...
                const res = await fetch(`${API_URL}/api/blog-posts/${id}`, { headers });
                if (!res.ok) {
                    navigate('/blog');
                    return;
                }
        ...
        const fetchComments = async () => {
            try {
                const res = await fetch(`${API_URL}/api/blog-posts/${id}/comments`);
                const data = await res.json();
                setComments(data);
            } catch (err) {
    ...
    const handleUpvote = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/blog-posts/${id}/upvote`, {
                method: 'POST',
