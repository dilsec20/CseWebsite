...
import { LayoutDashboard, Code, BookOpen, Trophy, LogOut, Edit2, Trash2, Plus, MessageSquare } from 'lucide-react';
...
const MyBlogs = ({ setAuth }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            {/* Sidebar (Duplicated from Dashboard for consistency if not a shared component) */}
            ...
            <main className="flex-1 overflow-y-auto p-8">
                <header className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">Manage all your discussions and articles.</p>
                    </div>
                    <button
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-lg shadow-xl animate-in fade-in zoom-in duration-200">
                        <div className="p-4 border-b flex justify-between items-center">
                            <h3 className="font-bold text-lg">{editingBlog ? 'Edit Post' : 'Create Post'}</h3>
                            <button onClick={() => setShowEditor(false)} className="p-1 hover:bg-gray-100 rounded-full transition">
                                <Edit2 className="h-5 w-5 rotate-45" /> {/* Close icon visual placeholder using existing imports or similar */}
                            </button>
                        </div>
                        <BlogsForm
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
                ...
                <textarea
                    ...
                    className="w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 h-48 resize-none"
