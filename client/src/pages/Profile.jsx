                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 mb-6">
                    <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-lg text-gray-500 mb-1">@{profileData.username}</p>
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500"
                                    />
                                </div>
